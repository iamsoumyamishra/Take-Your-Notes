            ...
            <div className="w-full bg-sidebar/80 backdrop-blur-xl border border-sidebar-border shadow-2xl shadow-primary/5 rounded-4xl p-8 md:p-10 flex flex-col gap-6 relative overflow-hidden">
                ...
                <div className="flex flex-col gap-2 text-center mt-2">
                    ...
                    <p className="text-sm font-medium text-muted-foreground mt-1">
                        Join NoteFlow to organize your thoughts and boost productivity.
                    </p>
                </div>
                ...
                <form onSubmit={handleSignup} className="flex flex-col gap-5 text-left">
                    <div className="space-y-4">
                        <div className="group relative">
                            ...
                            <div className="relative flex items-center">
                                <User className="absolute left-3.5 w-5 h-5 text-muted-foreground group-focus-within:text-primary transition-colors" />
                                <input
                                    type="text"
                                    required
                                    value={name}
                    ...
                    <p className="text-sm text-center text-muted-foreground mt-4 font-medium">
                        ...
                        <Link href="/sign-in" className="font-bold text-primary hover:text-primary/80 hover:underline transition-colors decoration-2 underline-offset-4 pointer-events-auto">
                            Sign in instead
                        </Link>
                    </p>
                </form>
